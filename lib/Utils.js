...
var Utils = /** @class */ (function () {
    ...
    Utils.prototype.balancesForAddress = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var network, tmpBITBOX, slpValidator, bitboxNetwork, balances;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Utils.prototype.balance = function (address, tokenId) {
        return __awaiter(this, void 0, void 0, function () {
            var network, tmpBITBOX, slpValidator, bitboxNetwork, balances, keys, val;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        network = addy.detectAddressNetwork(address);
    ...
    Utils.prototype.validate = function (txid, network) {
        return __awaiter(this, void 0, void 0, function () {
