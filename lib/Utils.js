...
var Utils = /** @class */ (function () {
    ...
    Utils.prototype.balancesForAddress = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var network, tmpBITBOX, path, slpValidator, bitboxNetwork, balances;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, bitboxNetwork.getAllSlpBalancesAndUtxos(address)];
                    case 1:
                        balances = _a.sent();
    ...
    Utils.prototype.balance = function (address, tokenId) {
        return __awaiter(this, void 0, void 0, function () {
            var network, tmpBITBOX, path, slpValidator, bitboxNetwork, balances, keys, val;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        network = addy.detectAddressNetwork(address);
