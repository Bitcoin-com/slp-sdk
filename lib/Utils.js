...
var Utils = /** @class */ (function () {
    ...
    Utils.prototype.balancesForAddress = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var network, tmpBITBOX, getRawTransactions, slpValidator, bitboxNetwork, balances, keys, axiosPromises, axiosResult;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Utils.prototype.balance = function (address, tokenId) {
        return __awaiter(this, void 0, void 0, function () {
            var network, tmpBITBOX, getRawTransactions, slpValidator, bitboxNetwork, balances, formattedTokens, keys, axiosPromises, val_1, axiosResult;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        balances = _a.sent();
                        formattedTokens = [];
                        if (!balances.slpTokenBalances) return [3 /*break*/, 3];
                        keys = Object.keys(balances.slpTokenBalances);
                        axiosPromises = keys.map(function (key) { return __awaiter(_this, void 0, void 0, function () {
                            var tokenMetadata;
                            return __generator(this, function (_a) {
                        ...
                        val_1 = "No balance for this address and tokenId";
                        return [4 /*yield*/, axios_1.default.all(axiosPromises)];
                    case 2:
                        axiosResult = _a.sent();
                        axiosResult.forEach(function (result) {
                            if (result.tokenId === tokenId) {
                                val_1 = result;
                            }
                        });
                        return [2 /*return*/, val_1];
                    case 3: return [2 /*return*/, "No balance for this address and tokenId"];
                }
            });
        });
    };
