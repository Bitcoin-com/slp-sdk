...
var Utils = /** @class */ (function () {
    ...
    Utils.prototype.balancesForAddress = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var network, tmpBITBOX, slpValidator, bitboxNetwork, balances, keys, axiosPromises, axiosResult, finalResult;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [2 /*return*/, balances.slpTokenBalances[key]
                    ...
                    case 2:
                        axiosResult = _a.sent();
                        finalResult = {};
                        keys.forEach(function (key, index) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        slpValidator = new slpjs.LocalValidator(tmpBITBOX, getRawTransactions ? getRawTransactions : tmpBITBOX.RawTransactions.getRawTransaction.bind(this));
    ...
    Utils.prototype.createValidator = function (network, getRawTransactions) {
        ...
        var slpValidator = new slpjs.LocalValidator(tmpBITBOX, getRawTransactions ? getRawTransactions : tmpBITBOX.RawTransactions.getRawTransaction.bind(this));
        return slpValidator;
    };
    return Utils;
}());
