...
var TokenType1 = /** @class */ (function () {
    ...
    TokenType1.prototype.p2sh = function (p2shConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var wif, tokenReceiverAddress, bchChangeReceiverAddress, tokenId, sendAmounts, redeemScript, network, bitbox, slp, helpers, fundingAddress, bitboxNetwork, tokenDecimals, tokenInfo, balances, inputUtxos, extraFee, unsignedTxnHex, scriptSigs, signedTxn;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        wif = p2shConfig.wif;
                        tokenReceiverAddress = p2shConfig.tokenReceiverAddress;
                        bchChangeReceiverAddress = p2shConfig.bchChangeReceiverAddress;
                        tokenId = p2shConfig.tokenId;
                        sendAmounts = p2shConfig.sendAmounts;
                        redeemScript = p2shConfig.redeemScript;
                        network = this.returnNetwork(bchChangeReceiverAddress);
                        bitbox = this.returnBITBOXInstance(network);
                        slp = new slpjs.Slp(bitbox);
                        helpers = new slpjs.TransactionHelpers(slp);
                        fundingAddress = slpjs.Utils.slpAddressFromHash160(bitbox.Crypto.hash160(redeemScript), network, "p2sh");
                    ...
                    case 2:
                        ...
                        sendAmounts = sendAmounts.map(function (a) {
                            return new BigNumber(a).times(Math.pow(10, tokenDecimals));
                        ...
                        extraFee = 8 * inputUtxos.length // for OP_CTLV and timelock data push // this many times since we swept inputs from p2sh address
                        ;
                        unsignedTxnHex = helpers.simpleTokenSend(tokenId, sendAmounts, inputUtxos, tokenReceiverAddress, bchChangeReceiverAddress, [], extraFee);
                        ...
                        scriptSigs = inputUtxos.map(function (txo, i) {
                            var sigObj = helpers.get_transaction_sig_p2sh(unsignedTxnHex, wif, i, txo.satoshis, redeemScript);
                            return {
                                index: i,
