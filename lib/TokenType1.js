...
var TokenType1 = /** @class */ (function () {
    ...
    TokenType1.prototype.burnAll = function (burnAllConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var tmpBITBOX_2, getRawTransactions, slpValidator, bitboxNetwork, tokenInfo, tokenDecimals, balances, inputUtxos, network, transactionBuilder_1, originalAmount_1, byteCount, sendAmount, keyPair_1, redeemScript_1, tx, hex, txid, error_2;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        tmpBITBOX_2 = this.returnBITBOXInstance(burnAllConfig.fundingAddress);
                        getRawTransactions = function (txids) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (network === "mainnet")
                            transactionBuilder_1 = new tmpBITBOX_2.TransactionBuilder("mainnet");
                        else
                            transactionBuilder_1 = new tmpBITBOX_2.TransactionBuilder("testnet");
                        originalAmount_1 = 0;
                        ...
                        byteCount = tmpBITBOX_2.BitcoinCash.getByteCount({ P2PKH: inputUtxos.length }, { P2PKH: 1 });
                        ...
                        keyPair_1 = tmpBITBOX_2.ECPair.fromWIF(burnAllConfig.fundingWif);
                        ...
                        hex = tx.toHex();
                        return [4 /*yield*/, tmpBITBOX_2.RawTransactions.sendRawTransaction(hex)];
                    case 3:
                        txid = _a.sent();
    ...
    TokenType1.prototype.burn = function (burnConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var tmpBITBOX_3, getRawTransactions, slpValidator, bitboxNetwork, fundingAddress, bchChangeReceiverAddress, tokenInfo, tokenDecimals, balances, amount, inputUtxos, burnTxid, error_3;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        tmpBITBOX_3 = this.returnBITBOXInstance(burnConfig.fundingAddress);
                        getRawTransactions = function (txids) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            switch (_a.label) {
