...
var TokenType1 = /** @class */ (function () {
    ...
    TokenType1.prototype.send = function (sendConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var network, BITBOX, bitboxNetwork, tokenId_1, bchChangeReceiverAddress, tokenInfo, tokenDecimals_1, amount_1, balances_1, inputUtxos, sendTxid, utxos_1, balances, tokenBalances, bchBalances, amount_2, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
