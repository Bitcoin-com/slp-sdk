...
var TokenType1 = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        common_1.validateAddressFormat(createConfig);
                        network = common_1.returnNetwork(createConfig.fundingAddress);
    ...
    TokenType1.prototype.nft = function (nftConfig) {
        return __awaiter(this, void 0, void 0, function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        // validate address formats
                        common_1.validateAddressFormat(mintConfig);
                        network = common_1.returnNetwork(mintConfig.fundingAddress);
                        BITBOX = common_1.returnBITBOXInstance(network);
                        bitboxNetwork = new slpjs.BitboxNetwork(BITBOX);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        // validate address formats
                        common_1.validateAddressFormat(sendConfig);
                        if (!Array.isArray(sendConfig.fundingAddress))
                            network = common_1.returnNetwork(sendConfig.fundingAddress);
                        else
                            network = common_1.returnNetwork(sendConfig.fundingAddress[0]);
                        BITBOX = common_1.returnBITBOXInstance(network);
                        bitboxNetwork = new slpjs.BitboxNetwork(BITBOX);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        // validate address formats
                        common_1.validateAddressFormat(burnConfig);
                        network = common_1.returnNetwork(burnConfig.fundingAddress);
                        BITBOX = common_1.returnBITBOXInstance(network);
                        bitboxNetwork = new slpjs.BitboxNetwork(BITBOX);
