...
var TokenType1 = /** @class */ (function () {
    ...
    TokenType1.prototype.create = function (createConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var network, BITBOX, bitboxNetwork, batonReceiverAddress, balances, initialTokenQty, genesisTxid, error_1;
    ...
    TokenType1.prototype.mint = function (mintConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var network, BITBOX, bitboxNetwork, batonReceiverAddress, balances, tokenInfo, mintQty, inputUtxos, mintTxid, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
    ...
    TokenType1.prototype.send = function (sendConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var network, BITBOX, bitboxNetwork, tokenId_1, amount_1, tokenInfo, tokenDecimals_1, balances_1, bchChangeReceiverAddress, inputUtxos, sendTxid, utxos_1, balances, tokenBalances, bchBalances, totalToken, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                    ...
                    case 5:
                        ...
                        totalToken = tokenBalances.reduce(function (t, v) { return (t = t.plus(v.result.slpTokenBalances[tokenId_1])); }, new BigNumber(0));
                        console.log("total token amount to distribute:", totalToken.toFixed());
                        console.log("spread amount", totalToken
                        ...
                        console.log("UTXO", utxos_1);
                        return [4 /*yield*/, bitboxNetwork.simpleTokenSend(tokenId_1, Array(sendConfig.fundingAddress.length).fill(totalToken.dividedToIntegerBy(sendConfig.fundingAddress.length)), utxos_1, sendConfig.fundingAddress, sendConfig.fundingAddress[0])];
    ...
    TokenType1.prototype.burn = function (burnConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var network, BITBOX, bitboxNetwork, bchChangeReceiverAddress, tokenInfo, tokenDecimals, balances, amount, inputUtxos, burnTxid, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
