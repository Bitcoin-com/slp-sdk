...
var TokenType1 = /** @class */ (function () {
    ...
    TokenType1.prototype.mint = function (mintConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var network, BITBOX, bitboxNetwork, batonReceiverAddress, balances_1, tokenInfo_1, mintQty_1, inputUtxos_1, mintTxid_1, balances, hasMintingBaton, inputUtxos, mintingBaton, i, balance, j, k, tokenInfo, mintQty, mintTxid;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        // validate address formats
                        ...
                        if (!Array.isArray(mintConfig.fundingAddress))
                            ...
                            network = this.returnNetwork(mintConfig.fundingAddress[0]);
                        BITBOX = this.returnBITBOXInstance(network);
                        bitboxNetwork = new slpjs.BitboxNetwork(BITBOX);
                        batonReceiverAddress = addy.toSLPAddress(mintConfig.batonReceiverAddress);
                        if (!(!Array.isArray(mintConfig.fundingAddress) &&
                            !Array.isArray(mintConfig.fundingWif))) return [3 /*break*/, 4];
                        return [4 /*yield*/, bitboxNetwork.getAllSlpBalancesAndUtxos(mintConfig.fundingAddress)];
                    case 1:
                        balances_1 = _a.sent();
                        if (!balances_1.slpBatonUtxos[mintConfig.tokenId])
                    ...
                    case 2:
                        tokenInfo_1 = _a.sent();
                        mintQty_1 = new BigNumber(mintConfig.additionalTokenQty).times(Math.pow(10, tokenInfo_1.decimals));
                        inputUtxos_1 = balances_1.slpBatonUtxos[mintConfig.tokenId];
                        inputUtxos_1 = inputUtxos_1.concat(balances_1.nonSlpUtxos);
                        inputUtxos_1.forEach(function (txo) { return (txo.wif = mintConfig.fundingWif); });
                        return [4 /*yield*/, bitboxNetwork.simpleTokenMint(mintConfig.tokenId, mintQty_1, inputUtxos_1, mintConfig.tokenReceiverAddress, batonReceiverAddress, mintConfig.bchChangeReceiverAddress)];
                    case 3:
                        mintTxid_1 = _a.sent();
                        return [2 /*return*/, mintTxid_1];
                    case 4: return [4 /*yield*/, bitboxNetwork.getAllSlpBalancesAndUtxos(mintConfig.fundingAddress)];
                    case 5:
                        balances = _a.sent();
                        hasMintingBaton = false;
                        inputUtxos = [];
                        for (i = 0; i < balances.length; i += 1) {
                            ...
                            if (!balance.slpBatonUtxos[mintConfig.tokenId]) {
                                ...
                                for (j = 0; j < balance.nonSlpUtxos.length; j += 1) {
                                ...
                                for (k = 0; k < mintingBaton.length; k += 1) {
                    ...
                    case 6:
                        ...
                        if (!Array.isArray(mintConfig.fundingWif))
                            throw Error("If fundingAddress is an Array, fundingWif must be a corresponding array.");
                        inputUtxos.forEach(function (txo) {
                            if (Array.isArray(mintConfig.fundingAddress)) {
                                mintConfig.fundingAddress.forEach(function (address, index) {
    ...
    TokenType1.prototype.send = function (sendConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var network, BITBOX, bitboxNetwork, tokenId, bchChangeReceiverAddress, tokenInfo, tokenDecimals, amount_1, balances_2, inputUtxos, sendTxid, utxos, balances, tokenBalances, bchBalances, amount;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        // validate address formats
                    ...
                    case 2:
                        ...
                        inputUtxos = balances_2.slpTokenUtxos[tokenId];
                        ...
                        inputUtxos = inputUtxos.concat(balances_2.nonSlpUtxos);
