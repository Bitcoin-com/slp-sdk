...
class RawTransactions {
  ...
  async input(rawtx, txid, n) {
    try {
      const response = await axios.post(`${this.restURL}rawTransactions/input/${rawtx}/${txid}/${n}`);
      return response.data;
    } catch (error) {
      if (error.response && error.response.data) throw error.response.data;
      throw error;
  ...
  async opReturn(rawtx, payload) {
    try {
      const response = await axios.post(`${this.restURL}rawTransactions/opReturn/${rawtx}/${payload}`);
      return response.data;
    } catch (error) {
      if (error.response && error.response.data) throw error.response.data;
      throw error;
  ...
  async create(inputs, outputs = {}) {
    try {
      const response = await axios.post(`${this.restURL}rawTransactions/create/${JSON.stringify(inputs)}/${JSON.stringify(outputs)}`);
      return response.data;
    } catch (error) {
      if (error.response && error.response.data) throw error.response.data;
      throw error;
