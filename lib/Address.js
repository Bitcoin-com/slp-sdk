            ...
            return __generator(this, function (_a) {
                try {
                    if (typeof address === "string") {
                        ...
                        return [2 /*return*/, BITBOX.Address.details(cashAddr)];
                    }
                    else {
                        address = address.map(function (address) {
                            return utils.toCashAddress(address);
                        });
                        return [2 /*return*/, BITBOX.Address.details(address)];
                    }
                }
                catch (error) {
                    throw error;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    if (typeof address === "string") {
                        cashAddr = utils.toCashAddress(address);
                        return [2 /*return*/, BITBOX.Address.utxo(cashAddr)];
                    }
                    else {
                        address = address.map(function (address) {
                            return utils.toCashAddress(address);
                        });
                        return [2 /*return*/, BITBOX.Address.utxo(address)];
                    }
                }
                catch (error) {
                    throw error;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    if (typeof address === "string") {
                        cashAddr = utils.toCashAddress(address);
                        return [2 /*return*/, BITBOX.Address.unconfirmed(cashAddr)];
                    }
                    else {
                        address = address.map(function (address) {
                            return utils.toCashAddress(address);
                        });
                        return [2 /*return*/, BITBOX.Address.unconfirmed(address)];
                    }
                }
                catch (error) {
                    throw error;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    if (typeof address === "string") {
                        cashAddr = utils.toCashAddress(address);
                        return [2 /*return*/, BITBOX.Address.transactions(cashAddr)];
                    }
                    else {
                        address = address.map(function (address) {
                            return utils.toCashAddress(address);
                        });
                        return [2 /*return*/, BITBOX.Address.transactions(address)];
                    }
                }
                catch (error) {
                    throw error;
